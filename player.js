function checkLevelUp() {
    while (state.player.xp >= state.player.nextLevelXp) {
        ...
        // Boost a stat every 3rd level, before HP calculation
        ...
        // Calculate HP with updated prowess (if boosted)
        ...
        state.combatLog.push(`Level up! Now level ${state.player.level}, Max HP increased by ${hpIncrease} to ${state.player.maxHp}`);
