...
The issue is that `ItemROGSystem.js` does not preserve all properties from the`partialItem`(which is`stub.data` from`MonsterSpawnSystem.js`).Specifically, `stub.data` contains:
```javascript
data: {
    tierIndex: 2,
    type: "armor",
